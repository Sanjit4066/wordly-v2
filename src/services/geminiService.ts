...

{
  ...
  "story": "a narrative micro-story (around 100-150 words) featuring a character, a brief action/conflict, and a resolution that naturally uses the word. Avoid general scene descriptions; tell a tiny, complete story."
}
